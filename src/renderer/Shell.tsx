    ...
    return (
        <div className="relative h-full overflow-hidden bg-ink text-cream">
            <div style={at(rects.tabBar)} className="flex flex-col">
                 ...
                 * the game pane's own header now — except when that pane is
                 * the tab's only one, which has no header, and whose controls
                 * sit here between the tabs and Settings instead.
                 */}
