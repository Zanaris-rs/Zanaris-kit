...
/** Pure, beside `serversView`: main builds it with every Settings push, handing it the presets it read once from their files. */
export function appearanceView(opts: { appearance: Appearance; catalog: readonly ServerDef[]; presets: readonly PresetCard[] }): AppearanceView {
