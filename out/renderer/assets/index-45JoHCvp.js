...
function Row({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between gap-4 py-[3px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-[12px] text-dim", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate font-mono text-[12px] tabular-nums", children })
  ] });
}
function SeedValue({ state }) {
  if (state === null) return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dim", children: "waiting for login" });
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full bg-ink", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-12 shrink-0 flex-col items-center border-l border-line py-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-auto font-semibold tracking-[0.18em] text-[11px] text-brass [writing-mode:vertical-rl] rotate-180", children: "SwiftKit" })
    ] })
  ] });
}
